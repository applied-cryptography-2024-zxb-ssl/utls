...
// Test_1 tests simple "abc" string hash
...
// Test_2 includes multiple sub-tests
func Test_2(t *testing.T) {
	...
	h := New()
	h.Write([]byte("abcdabcdabcdabcdabcdabcdabcdabcd"))
	h.Sum(nil)
	h.Write([]byte("abcdabcdabcdabcdabcdabcdabcdabcd"))
	hash_bytes := h.Sum(nil)
	hash_s = fmt.Sprintf("%x", hash_bytes)
	...
	// Reset
	h.Reset()
	h.Write([]byte(""))
	hash_bytes = h.Sum(nil)
	hash_s = fmt.Sprintf("%x", hash_bytes)
...
// Test_3 tests long string hash including Chinese characters
func Test_3(t *testing.T) {
	...
	hash := Sum([]byte(joke_1))
	s := fmt.Sprintf("%x", hash)
	if s != "95405487021d0b3ca08d177beb941a6b68079fb74522382dddf77ef216e9eca3" {
		t.Errorf("Err in Test_3_0")
	}
